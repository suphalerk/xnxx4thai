...
export default function AutoGrid() {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} style={{ marginLeft: '-10% !important', marginTop: '1% !important'  }}>
        <Grid item xs>
          <Paper className={classes.paper}></Paper>
        </Grid>
        <Grid item xs>
          <Paper className={classes.paper}><p className="text-green">ตอบโจทย์ทุกการซื้อขายกับเรา <img className="small-logo" src="/images/logo1.png" /></p>
          </Paper>
        </Grid>
        <Grid item xs>
          <Paper className={classes.paper}></Paper>
      ...
      <Grid container spacing={3} style={{ marginLeft: '-10% !important' }}>
        <Grid item xs>
          <Paper className={classes.paper}>
            <p className="text-header2">ผู้ขาย<Button className="btn-sell2">ลงขาย</Button></p>
        ...
        <Grid item xs>
          <Paper className={classes.paper}>
            <p className="text-header2" >ผู้ซื้อ<Button className="btn-sell3">ลงขาย</Button></p>
            <Typography color={"primary"} >
            <Image
              className="img-correct"
              src="/images/CORRECT.png"

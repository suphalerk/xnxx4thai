...
export default function AutoGrid() {
  ...
  return (
    <div className={classes.root} style={{backgroundColor:'#f2f2f2', marginTop:'1em'}}>
      <Grid container spacing={4}>
        
        <Grid item xs={12}>
          <Paper className={classes.paper}>
            <p className="text-green2">ตอบโจทย์ทุกการซื้อขายกับเรา <img className="small-logo" src="/images/logo1.png" /></p>
          </Paper>
        </Grid>
